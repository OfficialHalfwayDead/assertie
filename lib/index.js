...
export function assertTypeOfString(obj) {
    ...
    if (typeof obj !== "string")
        throw new AssertionError(`Provided object was not of type string. Was: ${getTypeNameOfUnknown(obj)}`);
}
export function assertTypeOfNumber(obj) {
    if (!import.meta.env.DEV)
        return;
    if (typeof obj !== "number")
        throw new AssertionError(`Provided object was not of type number. Was: ${getTypeNameOfUnknown(obj)}`);
}
export function assertTypeOfBoolean(obj) {
    if (!import.meta.env.DEV)
        return;
    if (typeof obj !== "boolean")
        throw new AssertionError(`Provided object was not of type boolean. Was: ${getTypeNameOfUnknown(obj)}`);
}
export function assertTypeOfBigint(obj) {
    if (!import.meta.env.DEV)
        return;
    if (typeof obj !== "bigint")
        throw new AssertionError(`Provided object was not of type bigint. Was: ${getTypeNameOfUnknown(obj)}`);
}
export function assertTypeOfUndefined(obj) {
    if (!import.meta.env.DEV)
        return;
    if (typeof obj !== "undefined")
        throw new AssertionError(`Provided object was not of type undefined. Was: ${getTypeNameOfUnknown(obj)}`);
}
...
export function assertTypeOfFunction(obj) {
    ...
    if (typeof obj !== "function")
        throw new AssertionError(`Provided object was not of type function. Was: ${getTypeNameOfUnknown(obj)}`);
}
export function assertTypeOfObject(obj) {
    if (!import.meta.env.DEV)
        return;
    if (typeof obj !== "object")
        throw new AssertionError(`Provided object was not of type object. Was: ${getTypeNameOfUnknown(obj)}`);
}
export function assertTypeOfSymbol(obj) {
    if (!import.meta.env.DEV)
        return;
    if (typeof obj !== "symbol")
        throw new AssertionError(`Provided object was not of type symbol. Was: ${getTypeNameOfUnknown(obj)}`);
}
...
export function assertInstanceOf(obj, constructable) {
    ...
    if (!(obj instanceof constructable))
        throw new AssertionError(`Provided object was not of type ${constructable.name} but was type: ${getTypeNameOfUnknown(obj)}, value: ${obj}`);
}
